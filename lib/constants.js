...
import MultipleWinnersProxyMainnet from '@pooltogether/pooltogether-contracts/deployments/mainnet/MultipleWinnersProxyFactory.json'
// import MultipleWinnersProxyRinkeby from '@pooltogether/pooltogether-contracts/deployments/rinkeby/MultipleWinnersProxyFactory.json'
// import CompoundPrizePoolProxyRopsten from '@pooltogether/pooltogether-contracts/deployments/ropsten/CompoundPrizePoolProxyFactory.json'
...
import PoolWithMultipleWinnersBuilder from '@pooltogether/pooltogether-contracts/deployments/localhost/PoolWithMultipleWinnersBuilder.json'
// import CompoundPrizePoolProxyFactory from '@pooltogether/pooltogether-contracts/deployments/localhost/CompoundPrizePoolProxyFactory.json'
...
export const CONTRACT_ADDRESSES = {
  ...
  42: {},
  31337: {
    MULTIPLE_WINNERS_PROXY: '0x68B1D87F95878fE05B998F19b66F4baba5De1aed',
    STAKE_PRIZE_POOL_PROXY: StakePrizePoolProxyRinkeby.address,
    // COMPOUND_PRICE_POOL_PROXY_FACTORY: CompoundPrizePoolProxyFactory.address,
    POOL_WITH_MULTIPLE_WINNERS_BUILDER: '0x4ed7c70F96B99c776995fB64377f0d4aB3B0e1C1',
    RNG_SERVICE: {
      blockhash: '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512',
      chainlink: RNGChainlinkMainnet.address,
    },
  },
}
...
export const BLOCK_NUMBERS = {
  ...
  42: {},
  31337: {
    POOL_WITH_MULTIPLE_WINNERS_BUILDER: PoolWithMultipleWinnersBuilder.receipt.blocknumber,
    MULTIPLE_WINNERS_PROXY: MultipleWinnersProxyMainnet.receipt.blockNumber,
    STAKE_PRIZE_POOL_PROXY: StakePrizePoolProxyRinkeby.receipt.blockNumber,
  },
}
...
export const CONTRACTS = Object.freeze({
  ...
  poolwithmultipleWinners: 'PoolWithMultipleWinners',
})
